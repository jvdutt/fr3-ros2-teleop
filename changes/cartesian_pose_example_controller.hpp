...
class CartesianPoseExampleController : public controller_interface::ControllerInterface {
 ...
 private:
  ...
  //added filters
    Eigen::Quaterniond orientation_raw;
    Eigen::Vector3d position_raw;
    Eigen::Vector3d position_filter1;
    Eigen::Quaterniond orientation_filter1;
    Eigen::Vector3d position_cmd;
    Eigen::Quaterniond orientation_cmd;

    double alpha1 = 0.999; // filter1 coefficient
    double beta =  0.99; // cmd coeff
